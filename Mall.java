...
public class Mall extends Business {
	...
	public String toString() {
		return "Mall [mRentedUnits=" + mRentedUnits + ", mMedianUnitSize=" + mMedianUnitSize + ", mNumParkingSpaces="
				+ mNumParkingSpaces + ", mNumRentableUnit=" + mNumRentableUnit + ", mProjectName=" + mProjectName
